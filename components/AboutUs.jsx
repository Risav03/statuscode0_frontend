...
import mem1 from "@assets/risav.png"
import mem2 from "@assets/sayak.png"
import mem3 from "@assets/aritra.png"
import mem4 from "@assets/manila.jpeg"
...
const AboutUs = () => {
  ...
  const TeamData = [
    {
        name: "Risavdeb Patra",
        position: "Smart Contracts & Frontend",
    ...
    },
    {
        ...
        github: "https://github.com/ManilaDas",
        linkedin: "https://www.linkedin.com/in/manila-das-523977227/",
        twitter: "https://twitter.com/manila_das1",
        img: mem4
    },];

  return (
    <div className="w-screen h-[100vh] flex flex-col items-center justify-center text-center text-white pb-40">
      <div className="text-3xl">
      <h1 className="text-blue-mid font-bold text-4xl mt-60 mb-40">Team</h1>
      <section class="flex justify-center">

   

<div class=" font-Montserrat grid gap-x-6 gap-y-28 lg:gap-x-12 md:grid-cols-4 min-[1500px]:w-[60%] w-[100%]">
...
<div class="rounded-xl shadow-xl shadow-slate-800 h-full block bg-gradient-to-bl from-[#070811] to-[#1c2c4e] border-x-4 border-blue-500 border-b-4 border-b-blue-500">
  <div class="flex justify-center">
    <div class="flex justify-center mt-[-100px] ">
      <Image src={member.img} class="border-4 border-blue-500 rounded-full w-40 mt-8 mx-auto shadow-lg" alt="mem1"/>
    </div>
  </div>
  <div class="p-4 pb-6">
